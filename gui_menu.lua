...
-- Khởi tạo bảng Settings mặc định (Bổ sung nút bật/tắt Safe màn hình)
local MySettings = {
    speedValue = 50,
    ...
    tpaEnabled = false,
    moveEnabled = false,
    showSafeSquare = true, -- Bật/tắt hiển thị nút Safe vuông
    tpSizeValue = 50,
    safeSizeValue = 50,
...
-- HÀNG 6: Nút chỉnh kích thước nút vuông vàng SAFE
...
-- TẠO NÚT VUÔNG VÀNG SAFE TRÊN MÀN HÌNH
...
-- HỆ THỐNG ESP MỚI: XÓA DÂY, TÊN NGƯỜI CHƠI MÀU ĐỎ TRÊN ĐẦU
